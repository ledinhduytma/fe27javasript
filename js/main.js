...
function themNhanVien() {
    ...
    isValid = validation.KiemTraKyTu("name", "tbTen", "(*) Vui lòng nhập đúng ký tự");
    isValid = validation.KiemTraEmail("email", "tbEmail", "(*) Vui lòng nhập lại Email");
    isValid = validation.KiemTraPassword("password", "tbMatKhau", "(*) Vui lòng nhập lại Mật Khẩu");
